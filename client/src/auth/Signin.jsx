...
const Signin = ({handleSignUpToggle, setSigninSuccess}) => {
  ...
  return (
    <div className='signin'>
        ...
        <h5 className='signin-message'>Enter your credentials to access your account</h5>
        
        <form onSubmit={handleSignin} className='signin-form'>

        <input type="text" required placeholder='User ID' id='signin-userid' name="mailID" onChange={handleOnChange}/>
        <p className={userNotFound ? "error-message-active" :"error-message-inactive"}>Please enter a valid phone number</p>
      
        <input type="password" required placeholder='Password' id='signin-password' name="password" onChange={handleOnChange}/>  
        ...
        <input type="button" value="Sign Up" onClick={handleSignUpToggle} id="signin-signup-btn"/>
        </form>
